...
url_manager.add_url(EXPRESSION_VIEW_TEMPLATE, VIEW_TEMPLATE)
...
url_manager.add_url(EXPRESSION_WEEKLY_TEMPLATE, WEEKLY_TEMPLATE)
...
url_manager.add_url(EXPRESSION_ADD_FROM_TEMPLATE, ADD_FROM_TEMPLATE)
url_manager.add_url(EXPRESSION_ADD_PERIOD_PROFILE, ADD_PERIOD_PROFILE)
url_manager.add_url(EXPRESSION_ADD_TEMPLATE_CLASS, ADD_TEMPLATE_CLASS)
url_manager.add_url(EXPRESSION_EDIT_TEMPLATE_CLASS, EDIT_TEMPLATE_CLASS)
...
url_manager.add_url(EXPRESSION_DELETE_TEMPLATE_CLASS, DELETE_TEMPLATE_CLASS)
...
url_manager.add_url(EXPRESSION_EDIT_TEMPLATE_PERIOD_PROFILE, EDIT_TEMPLATE_PERIOD_PROFILE)
